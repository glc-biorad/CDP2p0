...
def tc():
   ...
   #m.change_temperature(3,94)
    m.change_temperature(1,94)
    m.change_temperature(2,94)
    delay(300)
    ...
    for cycle in range(cycles):
        ...
        m.change_temperature(1,64)
        m.change_temperature(2,63)
        #m.change_temperature(4,60)
        print(m.get_temperature(2))
        delay(100)
        
        m.change_temperature(1,100)
    ...
    m.change_temperature(1,24)
    m.change_temperature(2,24)
