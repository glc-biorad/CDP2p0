...
def tc():
    ...
    for cycle in range(cycles):
        ...
        m.change_temperature(1,62)
        #m.change_temperature(3,58)
        m.change_temperature(2,60)
        print(m.get_temperature(2))
        delay(100)
        
        m.change_temperature(1,98)
        #m.change_temperature(3,97)
        m.change_temperature(2,99)
        print(m.get_temperature(2))
        delay(50)
    ...
    m.change_temperature(1,72)
    #m.change_temperature(3,72)
    m.change_temperature(2,72)
    print(m.get_temperature(2))
    delay(15*60)

    m.change_temperature(1,93)
    #m.change_temperature(3,94)
    m.change_temperature(2,95)
    delay(600)
    print(m.get_temperature(2))

    m.change_temperature(1,8)
    #m.change_temperature(3,8)
    m.change_temperature(2,8)
    delay(1800)
    print(m.get_temperature(2))

    m.change_temperature(1,18)
